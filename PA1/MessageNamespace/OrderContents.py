...
class OrderContents(object):
    ...
    def Veggies(self):
        ...
        if o != 0:
            ...
            from MessageNamespace.Veggies import Veggies
            obj = Veggies()
    ...
    def Drinks(self):
        ...
        if o != 0:
            x = self._tab.Indirect(o + self._tab.Pos)
            from MessageNamespace.Drinks import Drinks
            obj = Drinks()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Milk(self, j):
        ...
        if o != 0:
            ...
            from MessageNamespace.Milk import Milk
            obj = Milk()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Bread(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from MessageNamespace.Bread import Bread
            obj = Bread()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Meat(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from MessageNamespace.Meat import Meat
            obj = Meat()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
