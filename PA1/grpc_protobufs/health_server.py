...
# Health Server Class #
########################
class ServiceHandler (spg_grpc.DummyServiceServicer):
...
def parseCmdLineArgs ():
	...
	parser.add_argument ("-p", "--port", type=int, default=5577, help="Port to bind to (default: 5577)")
